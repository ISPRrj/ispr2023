...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -pg -g -Wall -Wextra -fno-tree-loop-distribute-patterns
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = fir_left
END

...
#
# create_project.tcl: Tcl script for re-creating project 'adc_dma'
#
# Generated by Vivado on Wed Mar 22 18:29:08 CET 2023
...
#
#    "/home/ispr/ispr/exercices/adc_dma/hw/project/adc_dma.srcs/sources_1/bd/system/system.bd"
#    "/home/ispr/ispr/exercices/adc_dma/hw/project/adc_dma.srcs/utils_1/imports/synth_1/system_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/ispr/ispr/exercices/adc_dma/hw/src/constr/adc_dma.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/project/adc_dma.srcs/sources_1/bd/system/system.bd"]"\
 "[file normalize "$origin_dir/project/adc_dma.srcs/utils_1/imports/synth_1/system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/src/constr/adc_dma.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/project/adc_dma.gen/sources_1/bd/system/hdl/system_wrapper.vhd" ]
} else {
...
set file "[file normalize "$origin_dir/src/constr/adc_dma.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/constr/adc_dma.xdc"
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/adc_dma.srcs/utils_1/imports/synth_1/system_wrapper.dcp" -objects $obj

...
#
# Generated by Vivado on Wed Feb 15 18:55:35 CET 2023
...
#
#    "/home/ispr/ispr/tutorials/lab2/hw/project/lab2.srcs/sources_1/bd/system/system.bd"
#    "/home/ispr/ispr/tutorials/lab2/hw/project/lab2.srcs/utils_1/imports/synth_1/system_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/ispr/ispr/tutorials/lab2/hw/src/constr/lab2.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/project/lab2.srcs/sources_1/bd/system/system.bd"]"\
 "[file normalize "$origin_dir/project/lab2.srcs/utils_1/imports/synth_1/system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/src/constr/lab2.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/project/lab2.gen/sources_1/bd/system/hdl/system_wrapper.vhd" ]
} else {
...
set file "[file normalize "$origin_dir/src/constr/lab2.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/constr/lab2.xdc"
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/lab2.srcs/utils_1/imports/synth_1/system_wrapper.dcp" -objects $obj

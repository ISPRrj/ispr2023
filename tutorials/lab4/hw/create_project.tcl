...
#
# Generated by Vivado on Wed Mar 22 15:23:47 CET 2023
...
#
#    "/home/ispr/ispr/tutorials/lab4/hw/project/lab4.srcs/sources_1/bd/system/system.bd"
#    "/home/ispr/ispr/tutorials/lab4/hw/project/lab4.srcs/utils_1/imports/synth_1/system_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/project/lab4.srcs/sources_1/bd/system/system.bd"]"\
 "[file normalize "$origin_dir/project/lab4.srcs/utils_1/imports/synth_1/system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/src/constr/lab4.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/project/lab4.gen/sources_1/bd/system/hdl/system_wrapper.vhd" ]
} else {
...
set file "$origin_dir/src/constr/lab4.xdc"
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/lab4.srcs/utils_1/imports/synth_1/system_wrapper.dcp" -objects $obj
